const cookieName = '美团'
const tokenurlKey = 'james_tokenurl_meituan'
const tokenheaderKey = 'james_tokenheader_meituan'
const signurlKey = 'james_signurl_meituan'
const signheaderKey = 'james_signheader_meituan'
const signbodyKey = 'james_signbody_meituan'
const chavy = init()
